...
urlpatterns = [
    ...
    path(
        ...
        student_views.syllabus_detail,
        name="student_syllabus_detail",
    ),
    path(
        "student/attendance/",
        student_views.attendance_list,
        name="student_attendance_list",
    ),
    path(
        "student/attendance/<uuid:course_id>/",
    ...
    path(
        ...
        professor_views.upload_syllabus,
        name="professor_upload_syllabus",
    ),
    path(
        "professor/attendance/record/<uuid:group_id>/",
        professor_views.record_attendance,
        name="professor_record_attendance",
    ),
    path(
        "professor/attendance/report/<uuid:group_id>/",
        professor_views.attendance_report,
        name="professor_attendance_report",
    ),
    path(
        "professor/grades/record/<uuid:group_id>/",
        professor_views.consolidated_grades,
        name="professor_record_grades",
    ),
    path(
        "professor/grades/<uuid:course_id>/upload-csv/",
        professor_views.upload_grades_csv,
        name="professor_upload_grades_csv",
    ),
    path(
        "professor/api/progress/<uuid:group_id>/",
    ...
    path(
        ...
        secretaria_views.ClassroomListView.as_view(),
        name="secretaria_classrooms",
    ),
    path(
        "secretaria/classrooms/new/",
        secretaria_views.ClassroomCreateView.as_view(),
        name="secretaria_classroom_add",
    ),
    path(
        "secretaria/classrooms/<uuid:pk>/edit/",
        secretaria_views.ClassroomUpdateView.as_view(),
        name="secretaria_classroom_edit",
    ),
    path(
        "secretaria/classrooms/<uuid:pk>/delete/",
    ...
    path(
        ...
        name="secretaria_upload",
    ),
    path(
        "secretaria/upload/group/<uuid:group_id>/",
        secretaria_views.upload_students_to_group_view,
        name="secretaria_upload_students_to_group",
    ),
    path(
        "secretaria/reportes/notas/",
        secretaria_views.SecretariaGradeReportView.as_view(),
        name="secretaria_grade_report",
    ),
    path(
        "secretaria/reportes/notas/descargar/<uuid:group_id>/",
    ...
    path(
        ...
        name="secretaria_syllabus_list",
    ),
    path(
        "secretaria/syllabus/process/<uuid:syllabus_id>/",
        secretaria_syllabus_views.ProcessSyllabusView.as_view(),
        name="secretaria_process_syllabus",
    ),
    path(
        "secretaria/syllabus/process-all/",
    ...
    path(
        ...
        name="secretaria_lab_management",
    ),
    path(
        "secretaria/laboratories/create/",
        secretaria_lab_views.CreateLabGroupView.as_view(),
        name="secretaria_lab_create",
    ),
    path(
        "secretaria/laboratories/<uuid:lab_id>/delete/",
        secretaria_lab_views.DeleteLabGroupView.as_view(),
        name="secretaria_lab_delete",
    ),
    path(
        "secretaria/laboratories/check-conflicts/",
        secretaria_lab_views.CheckScheduleConflictsView.as_view(),
        name="secretaria_lab_check_conflicts",
    ),
    path(
